...
**Bottom line.** Headline CPI tells you the cost of living; core inflation shows the underlying trend the RBI watches.
...
### Key terms
- **Headline inflation** — It is the all-items CPI number you see in the news. Think of it as the average price change across everything a household buys, from toothpaste to tuition fees. It does not mean every price moved the same way.
- **Core inflation** — It is headline CPI after removing food and fuel. It is like reading the temperature of a patient after removing the fever spike from an infection – it shows the underlying trend. It is a policy tool, not a cost-of-living measure.
- **Repo rate** — The interest rate at which the RBI lends to banks. When it goes up, your home loan EMI gets costlier and businesses borrow less. It cools demand across the economy but cannot make onions cheaper.

### Thik hai, but what does it mean for me?
Imagine you go to the market and potatoes are ₹15 a kilo, half of what they were last year. Your neighbour tells you inflation is down, so you should be happy. But when you take your child to the doctor, the consultation fee is ₹800, up from ₹700. And the school has just sent a notice raising tuition by 8%. That split is exactly what the RBI deals with. The vegetable cart is screaming ‘low inflation’, the clinic and the school are quietly saying ‘high inflation’. The repo rate that affects your home loan EMI is set by looking at the clinic, not the cart. So next time someone says ‘inflation is only 2%’, remember to ask: in what? And for whom?

### What people get wrong
That core inflation is the ‘real’ inflation and headline is somehow gimmicked. Both are real. Headline captures what households actually spend; core isolates the part policymakers can influence.

### Caveat
Core inflation excludes the two items that matter most to poor households, food and fuel. It is a policy tool, not a welfare measure.

---
**Connects:** food-inflation, what-is-inflation, cpi-vs-wpi, inside-the-basket, whose-inflation
**Sources:** MoSPI; RBI; World Bank; IndiaDataHub
**Locked numbers used:** CPI inflation, General (Combined), latest; CPI core inflation (excluding food and fuel), latest; CPI core inflation (excluding food and fuel), earliest; CPI inflation excluding food, latest; CPI inflation excluding food, earliest; CPI inflation, Food and Beverages (Combined), latest; RBI policy repo rate, latest; RBI policy repo rate, earliest; CPI 2024 weight, Food and beverages; CPI 2024 weight, Housing, water, electricity and fuels; CPI 2024 weight, Transport and communication; CPI 2024 weight, Health; CPI 2024 weight, Food and beverages, OLD 2012 basket (for comparison); CPI 2024 headline inflation, January 2026; CPI 2024 number of items in basket; CPI inflation, Food and Beverages: Vegetables (Combined), latest; CPI inflation, Food and Beverages: Pulses and Products (Combined), latest; Price inflation, Onion, latest; Price inflation, Potato, latest; CPI inflation, Miscellaneous: Health (Combined), latest; CPI inflation, Miscellaneous: Education (Combined), latest; CPI inflation, Miscellaneous (Combined), latest; CPI inflation, Food and Beverages: Oils and Fats (Combined), latest
**Context cards used:** Core inflation strips out food and fuel from the headline index (monetary economics); Under the 2016 framework the RBI's legal target is headline CPI at 4 percent (central banking / policy); On 12 February 2026 India launched a new Consumer Price Index series with base year 2024 (statistics / method)
**Status:** ready

### Self-critique
- **Wrong:** All numbers are from locked numbers; no factual slips. Azadpur mandi is a specific Indian market example, permissible. No false cause claims.
- **Missing:** No table to break down the extreme divergence in component inflation numbers for December 2025, which would ground the abstraction.
- **To add:** Add a markdown table in the 'When headline and core disagree' section showing key component inflation rates from the locked numbers (vegetables, pulses, oils, health, education, miscellaneous) alongside headline and core, making the contrast visible.
- **Relevance:** The onTheGround section works well. The table will directly answer a reader’s question: 'What does this look like in specific items?'
- **AI smell:** Some paragraphs are uniformly medium-length; inject a few very short sentences and vary rhythm. No hard banned words detected.
- **Better how:** Start with an even sharper opening image (already okay). Tighten the later 'dilemma' sections to avoid slight repetition, and ensure the table anchors the divergence.
