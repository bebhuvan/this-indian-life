# How can India be a top-five economy and still one of the poorest?
*The same country is an economic giant and, person by person, near the bottom.*

**Bottom line.** India's total GDP puts it among the world's five largest economies; per-capita GDP shows it remains one of the poorest.
...
### Key terms
- **Gross Domestic Product (GDP)** — Total value of goods and services produced within a country's borders in a year. Think of it as the country's annual output, not income. It includes what foreign companies produce inside the country.
- **Gross National Income (GNI)** — Like GDP, but adjusted for earnings from abroad. It's what residents of a country earn, regardless of where the production happens.
- **Purchasing Power Parity (PPP)** — A way of comparing economic sizes by equalising buying power. A rupee in India buys more than a rupee's worth of dollars in the US, so PPP raises India's rank.
- **Per-capita GDP** — GDP divided by population. An arithmetic average, not a measure of typical earnings. It hides inequality.

### Bada hai, par ameer nahi
Imagine the whole country is a giant factory churning out goods and services worth $3.91 trillion a year. That’s huge, enough to get a seat at the G20 table and make other countries pick up the phone. But split that output among 1.4 billion people, and each person gets a share worth about $2,700 a year, or roughly ₹20,000 a month. That’s not a salary anyone receives; it’s just the average slice of the national pie if it were divided equally. In reality, most people’s slice is much thinner. So when the news says ‘India is now the fifth-largest economy,’ remember: that’s about the country’s weight in the world. When you look at your own pay slip, you’re living the other half of the story.

### What people get wrong
That a top-five economy means India is rich, or that low per-capita means India is unimportant. Both are false; size and per-person welfare are different dimensions.

### Caveat
Per-capita GDP is an average, not a distribution. PPP estimates are based on international price surveys that are updated only periodically. The market-exchange-rate ranking can shift with currency movements without any change in domestic output.

---
**Connects:** what-is-gdp, structural-change, who-spends, what-gdp-ignores
**Sources:** World Bank; Ministry of Statistics and Programme Implementation (MoSPI); Standard national-accounts / ICP methodology
**Locked numbers used:** India GDP at market exchange rate, latest; China, GDP (market exchange rate), latest; Japan, GDP (market exchange rate), latest; Germany, GDP (market exchange rate), latest; United Kingdom, GDP (market exchange rate), latest; India GDP at purchasing-power parity, latest; India, GDP per capita (market exchange rate), latest; Bangladesh, GDP per capita (market exchange rate), latest; China, GDP per capita (market exchange rate), latest; South Korea, GDP per capita (market exchange rate), latest; Indonesia, GDP per capita (market exchange rate), latest; Vietnam, GDP per capita (market exchange rate), latest; India, GDP per capita (market exchange rate), earliest; China, GDP per capita (market exchange rate), earliest; Per capita GDP, nominal, latest; Gross National Income, nominal, latest; Net primary income paid abroad (GDP − GNI), latest; GDP, nominal, latest; Household saving as % of GDP, latest; Household saving as % of GDP, earliest; Agriculture share of GVA, latest; Industry share of GVA, latest; Services share of GVA, latest
**Context cards used:** Purchasing-power parity (PPP) adjusts for the fact that the same money buys much more in India than in a rich country...
**Status:** ready

### Self-critique
- **Wrong:** Used ₹83 exchange rate (not from locked numbers). Used Ireland claim (not from context cards). Derived ratios 'four times', 'five times', 'one-thirteenth' from locked numbers. Mentioned TRIPS waiver without a context card. Em-dashes throughout body and pull quotes. Rhetorical pivot '? The answer is'.
- **Missing:** Could link sectoral composition (agriculture vs services) to the gap between output and incomes, but no employment data to support it.
- **To add:** Early per-capita figures (1960) already added texture; saving rate decline already used; no other locked numbers needed.
- **Relevance:** Grounding already concrete: monthly ₹20,800, chawl example, Azadpur mandi. No abstraction left un-cashed.
- **AI smell:** Em-dashes and the pivot were strong tells; after removal, prose is plainer and rhythm more varied. No banned constructions remain.
- **Better how:** Removing derived ratios forced blander comparisons; the concreteness now comes from the absolute figures themselves. The close already ties back to the G20 summit vs domestic margin; it’s sharp enough.
