...
**Bottom line.** GDP is the total market value of all final goods and services produced within India in a year; it measures production, not wealth, not income people receive, and certainly not wellbeing.
...
The headline number tells you the sheer scale of production and its growth. India's nominal GDP has climbed from ₹10,221.6 crore in 1950-51 to ₹357.1 lakh crore in 2025-26. In real terms, GDP rose from ₹5 lakh crore in 1950-51 to ₹201.9 lakh crore in 2025-26, and per-capita real output moved from ₹16,905 to ₹1.4 lakh over the same period.
...
### Key terms
- **GDP** — Imagine a giant village mela where every stall's final sales are added up: the food sold, the toys, the rides. GDP is that for the whole country, but only for things sold for money (or with an imputed price like rent on your own house). It is not a measure of wealth accumulated, nor of people's well-being.
- **Final goods and services** — The stuff that reaches the end user, not the flour bought by a bakery to make bread. A steel beam sold to a builder counts as intermediate; the finished flat does not. Double-counting is the error GDP accounting is built to avoid. Final does not mean 'finished for good.' A car is final when sold to a family, intermediate when bought by a taxi fleet.
- **Domestic** — Within the boundaries of India, whether the factory is owned by an Indian or a foreigner. A Suzuki plant in Gujarat produces domestic GDP; an Infosys office in Texas does not.
- **Flow** — Flow is the water passing one point in the river in a second; stock is the water in the lake. GDP is a flow per year, not the total wealth of the nation sitting in banks and buildings.
- **GVA (Gross Value Added)** — The value a business adds to the things it bought from others. If a dhaba buys vegetables for ₹200 and sells thalis for ₹500, its GVA is ₹300, the wages, rent, profit, and depreciation it generated. GVA plus net product taxes equals GDP.
- **Informal sector** — All the economic activity that happens without formal registration: the chai tapri, the household tailor, the unorganised agri-labour. Because there are no systematic sales records, statisticians estimate it, often by using the formal sector as a yardstick. This is the heart of the measurement debate.

### Thik hai, bhai, lekin mere liye isse kya?
When you hear that GDP grew at 7.4 percent, don't imagine a pay rise for everyone. It means the sum total of factories humming, apps being written, crops harvested, and chai sold on the platform was larger than last year. Some of that growth might have come from a few big companies while your local kirana struggled. The number is real, but it's like a selfie taken from far away: you can see the crowd, just not who is smiling and who is not. GDP cannot tell you if your rent went up faster than your salary, or if your mother's unpaid work at home got counted. As a citizen, you should care because governments, ratings agencies, and investors all steer by this number. But read it the way you'd read a train's arrival time at a station where the tracks can shake: it tells you the general direction, but keep an eye on your own platform.

### What people get wrong
The single most common mistake is treating GDP as income that households actually receive. GDP is production; per-capita GDP is an arithmetic division, not a salary anyone is paid. When GDP rises, it does not mean everybody or even most people feel richer.

### Caveat
The honest limit is that GDP is a production tally, not a scorecard of welfare. It cannot tell you about inequality, environmental damage, or the well-being of ordinary people. The measurement itself is based on assumptions that are actively contested, so the growth rate should be read with caution.

---
**Connects:** value-added, final-vs-intermediate, domestic-meaning, stocks-vs-flows, what-gdp-ignores, nominal-gdp, informal-economy, back-series, next-base-year
**Sources:** MoSPI National Accounts; World Bank World Development Indicators; Kuznets, report to the US Congress, 1934; National Income Committee, Government of India, 1949; Marilyn Waring, 'If Women Counted' (1988); Anand, Felman & Subramanian, PIIE Working Paper 26-3, March 2026; PM Economic Advisory Council response, 2019; MoSPI methodology revision, February 2026
**Locked numbers used:** GDP, nominal, latest; GDP, nominal, earliest; GDP, real (2011-12 prices), latest; GDP, real (2011-12 prices), earliest; Real GDP growth rate, latest; Per capita GDP, nominal, latest; Per capita GDP, nominal, earliest; Per capita GDP, real (2011-12 prices), latest; Per capita GDP, real (2011-12 prices), earliest; Gross National Income, nominal, latest; Gross Value Added (total), nominal, latest; Net taxes on products, nominal, latest; Net Domestic Product, nominal, latest; Depreciation, latest year (GDP minus NDP, same vintage); Agriculture share of GVA, latest; Agriculture share of GVA, earliest; Services share of GVA, latest; India GDP at market exchange rate, latest; Japan — GDP (market exchange rate), latest; Germany — GDP (market exchange rate), latest; United Kingdom — GDP (market exchange rate), latest; India GDP at purchasing-power parity, latest; Private consumption as % of GDP, latest; Gross fixed capital formation as % of GDP, latest; Government consumption as % of GDP, latest; Net exports as % of GDP, latest; GVA — agriculture, nominal, latest; GVA — industry, nominal, latest; GVA — services, nominal, latest; Manufacturing share of GVA, latest; Net primary income paid abroad (GDP − GNI), latest
**Context cards used:** GDP and national income accounting are 20th-century inventions...; India's first official national-income estimates came from the National Income Committee...; GDP can be built three equivalent ways...; Where GDP draws its 'production boundary' is a convention...; Whether India even measures its growth correctly is a live, public argument...; The government has contested these claims...
**Status:** ready

### Self-critique
- **Wrong:** The draft included a ranking that relied on US data not in the evidence (stating India was fifth-largest behind the US), and a '40-fold' increase computed from raw numbers (not present in locked figures). The Naoroji sentence used 'a significant share' which slightly extended the context card's 'draining wealth'. These are corrected.
- **Missing:** A breakdown of GDP by expenditure components (consumption, investment, etc.) and the distinction between GDP and GNI would ground the size of the economy more completely. The closing paragraph could be tighter and less instructional ('For a reader...').
- **To add:** Added private consumption share (61.5%), investment share (30%), government consumption (9.9%), and net exports (-2.3%) from locked numbers. Added nominal GVA by sector (agriculture ₹54.3 lakh crore, industry ₹86.8 lakh crore, services ₹182.4 lakh crore) and manufacturing share (14.1%, ₹45.5 lakh crore). Added GNI figure (₹351.6 lakh crore) and net income paid abroad (₹5.5 lakh crore) to clarify domestic vs. national. Removed the fold-change claim and corrected country comparisons using only provided data.
- **Relevance:** The examples are already concrete (Tiruppur factory, Madurai saloon, street vendor). The added spending composition helps a reader see where their own household consumption and the government's role fit into the big picture.
- **AI smell:** Removed the flagged 'Moreover' from the caveat. The closing is tightened by removing 'For a reader' and the thermometer/pointer analogy is kept but made more direct. No other AI-syntax tells remain.
- **Better how:** Sharpened the closing to be a direct takeaway without a meta-instruction. Eliminated all derived ratios not present in the evidence. Used only locked numbers for cross-country comparisons.
