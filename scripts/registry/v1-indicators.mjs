...
export const v1Questions = [
  ...
  },
  {
    ...
    context: ["people.population.total", "people.population.growth", "people.fertility", "people.population.un.total"]
  },
  {
    id: "q.people.age",
  ...
  },
  {
    ...
    context: ["people.population.un.median_age", "people.population.un.broad_age_share", "people.age_65_plus_share"]
  },
  {
    id: "q.econ.size",
    ...
    indicators: [
      ...
      "econ.idh.nominal_gdp_quarterly",
      "econ.idh.real_gdp_quarterly",
      "econ.idh.per_capita_nominal_gdp",
      "econ.idh.gva_agriculture_nominal",
      "econ.idh.gva_industry_nominal",
      "econ.idh.gva_services_nominal",
      "econ.idh.private_consumption_nominal",
      "econ.idh.gross_capital_formation_nominal",
      "econ.idh.government_consumption_nominal",
      "econ.idh.exports_nominal",
      "econ.idh.imports_nominal",
      "econ.idh.net_exports_nominal"
    ],
    core: [
      "econ.idh.nominal_gdp_annual",
      "econ.idh.real_gdp_annual",
    ...
    // Comprehensive GDP teaching page: locked to its own accounting set, no tax/debt/inflation leak.
    context: []
  },
  {
    id: "q.econ.growth",
  ...
  },
  {
    ...
    visualPlan: [
      { chart: "multiLine", title: "Annual average temperature in four Indian cities", size: "hero", beat: "signal", window: "full", unit: "°C", subtitle: "Open-Meteo ERA5 · annual mean of daily mean temperature",
        series: [
        ...
        indicator: "climate.openmeteo.delhi.mean_temperature",
        why: "The cleanest long-run city signal before moving into extremes." },
      { chart: "multiLine", title: "Very hot days each year", size: "feature", beat: "extreme-days", window: "full", unit: "days", subtitle: "Open-Meteo ERA5 · days with maximum temperature at or above 35°C",
        series: [
        ...
        why: "Averages can hide the days people actually feel as dangerous heat." },
      { chart: "multiLine", title: "Hot nights each year", size: "feature", beat: "night-heat", window: "full", unit: "nights", subtitle: "Open-Meteo ERA5 · nights with minimum temperature at or above 28°C",
        series: [
        ...
        why: "Night heat matters because it shows when the day does not cool down." }
    ]
  },
  {
