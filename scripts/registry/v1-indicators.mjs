  ...
  },
  {
    ...
    visualPlan: [
      ...
      { indicator: "econ.nas.per_capita_gdp_nominal", chart: "line", title: "GDP per person", size: "feature", window: "full", beat: "per-person",
        why: "Divide the economy by 1.4 billion people and the picture changes completely.", read: "GDP split evenly across everyone: about ₹404 a year in the 1960s, about ₹2.5 lakh now. A big rise, but it is an arithmetic average.", watch: "This is not a salary or a typical income. A small number of high earners pull the average well above what most Indians actually make." },
