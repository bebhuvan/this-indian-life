...
export const v1Questions = [
  ...
  },
  {
    ...
    // reconciled to the June 2026 published fiscal-year table. Independent travel
    // context: Bureau of Immigration departures via the Tourism Data Compendium 2025.
    indicators: [
      "extfin.lrs.total.fy",
      "extfin.lrs.limit_history",
      "extfin.lrs.travel.fy",
      "extfin.lrs.relatives.fy",
      "extfin.lrs.gift.fy",
      "extfin.lrs.studies.fy",
      "extfin.lrs.asset_building.fy",
      "extfin.lrs.investment.fy",
      "extfin.lrs.property.fy",
      "extfin.lrs.deposit.fy",
      "extfin.lrs.purpose.latest",
      "extfin.lrs.deposit.monthly",
      "extfin.lrs.property.monthly",
      "extfin.lrs.investment.monthly",
      "extfin.lrs.gift.monthly",
      "extfin.lrs.donations.monthly",
      "extfin.lrs.travel.monthly",
      "extfin.lrs.relatives.monthly",
      "extfin.lrs.medical.monthly",
      "extfin.lrs.studies.monthly",
      "extfin.lrs.others.monthly",
      "extfin.lrs.purpose.latest_vs_own_peak",
      "extfin.lrs.deposit.peak_change",
      "extfin.lrs.property.peak_change",
      "extfin.lrs.investment.peak_change",
      "extfin.lrs.gift.peak_change",
      "extfin.lrs.donations.peak_change",
      "extfin.lrs.travel.peak_change",
      "extfin.lrs.relatives.peak_change",
      "extfin.lrs.medical.peak_change",
      "extfin.lrs.studies.peak_change",
      "extfin.lrs.others.peak_change",
      "extfin.lrs.travel_split.mar_apr_2026",
      "extfin.lrs.travel_index_2016",
      "tourism.outbound_departures_index_2016",
      "extfin.lrs.total.monthly",
      "extfin.lrs.tcs_oct_2023",
      "IN.fx.inr_usd.monthly"
    ],
    core: [
      "extfin.lrs.total.fy",
      "extfin.lrs.travel.fy",
    ...
    visualPlan: [
      { indicator: "extfin.lrs.total.fy", chart: "line", title: "LRS remittances eased to $29 billion after a $31.7 billion peak", size: "hero", window: "full", beat: "scale", unit: "US$ billion",
        subtitle: "Money sent abroad under LRS by people resident in India · each financial year from FY2009-10 to FY2025-26",
        why: "The headline scale grew from about $1 billion to nearly $29 billion a year.",
        read: "Each point sums the ten top-level purposes for one April-to-March financial year.",
        watch: "The jump after May 2015 is partly a reporting-coverage break: RBI brought travel and other current-account facilities inside LRS. Do not read the whole rise as behaviour." },
      { indicator: "extfin.lrs.limit_history", chart: "tableBars", title: "The legal LRS ceiling moved from $25,000 to $250,000", size: "feature", beat: "policy-limit", unit: "US$ thousand per resident individual",
        subtitle: "The maximum one resident could send abroad under LRS in a financial year · seven rule changes since 2004",
        why: "The scheme itself changed repeatedly before settling at today's ceiling.",
        read: "Each bar is the maximum one resident individual could remit in the applicable period.",
        watch: "A ceiling is not actual spending. The May 2015 change also expanded which transactions were counted, so limit and coverage moved together." },
      { chart: "multiLine", title: "Travel dominated LRS except during the pandemic year", size: "feature", beat: "composition-over-time", unit: "US$ billion",
        subtitle: "Annual amounts sent for Travel, family support, gifts, studies, deposits, property and investments · FY2009-10 to FY2025-26",
        indicator: "extfin.lrs.travel.fy",
        series: [
          { indicator: "extfin.lrs.travel.fy", label: "Travel", emphasis: true },
          { indicator: "extfin.lrs.relatives.fy", label: "Maintenance of relatives" },
          { indicator: "extfin.lrs.gift.fy", label: "Gifts" },
          { indicator: "extfin.lrs.studies.fy", label: "Studies abroad" },
          { indicator: "extfin.lrs.asset_building.fy", label: "Deposits, property and investments" }
        ],
        why: "The total changed because the purpose mix changed, especially after current-account travel entered LRS.",
        read: "Compare the annual dollar level of each major purpose, not only its latest share.",
        watch: "The Studies Abroad label changes meaning in the newest reporting: RBI now separates travel for education from education services bought without travel." },
      { chart: "sparkGrid", title: "The full monthly record, one LRS purpose at a time", size: "feature", beat: "browse-all-monthly", unit: "US$ billion", fromYear: 2008,
        subtitle: "Monthly amount sent for each of RBI's ten main LRS purposes · full available record, April 2008 to April 2026",
        indicator: "extfin.lrs.travel.monthly",
        series: [
          { indicator: "extfin.lrs.travel.monthly", label: "Travel" },
          { indicator: "extfin.lrs.relatives.monthly", label: "Maintenance of relatives" },
          { indicator: "extfin.lrs.investment.monthly", label: "Equity/debt investment" },
          { indicator: "extfin.lrs.gift.monthly", label: "Gifts" },
          { indicator: "extfin.lrs.studies.monthly", label: "Studies Abroad" },
          { indicator: "extfin.lrs.deposit.monthly", label: "Deposits" },
          { indicator: "extfin.lrs.property.monthly", label: "Property purchases" },
          { indicator: "extfin.lrs.others.monthly", label: "Others" },
          { indicator: "extfin.lrs.medical.monthly", label: "Medical treatment" },
          { indicator: "extfin.lrs.donations.monthly", label: "Donations" }
        ],
        why: "Annual sums hide timing, spikes and categories too small to survive on a shared scale; the small multiples expose every published top-level value in the workbook.",
        read: "Each panel has its own vertical scale. Read its shape and turning points, not one panel's height against another.",
        watch: "Independent scales make small categories visible but prevent cross-panel level comparisons. Early gaps are unpublished cells, not zeroes; use the FY2025-26 ranking for size." },
      { indicator: "extfin.lrs.purpose.latest", chart: "tableBars", title: "Travel led all ten LRS purposes in FY2025-26", size: "feature", beat: "composition-now", unit: "US$ billion",
        subtitle: "Where the $28.98 billion total went across RBI's ten main purposes · FY2025-26",
        why: "The full latest breakdown stops property or investment from being mistaken for the whole story.",
        read: "The ten bars add to about $29 billion. Travel alone is about $16.4 billion.",
        watch: "RBI's Others footer combines journals, investment maintenance, student-loan repayments and credit-card payments. It is a residual, not one behaviour." },
      { chart: "rankedChange", title: "Investment rose even as total LRS remittances fell from the peak", size: "feature", beat: "change-from-peak", unit: "US$ billion", baselineYears: 1, latestYears: 1, startLabel: "FY2023-24", endLabel: "FY2025-26", rowLabel: "Purpose",
        subtitle: "Change in the annual amount for each purpose between the overall peak and the latest year · FY2023-24 to FY2025-26",
        series: [
          { indicator: "extfin.lrs.travel.peak_change", label: "Travel" },
          { indicator: "extfin.lrs.relatives.peak_change", label: "Maintenance of relatives" },
          { indicator: "extfin.lrs.studies.peak_change", label: "Studies abroad" },
          { indicator: "extfin.lrs.gift.peak_change", label: "Gifts" },
          { indicator: "extfin.lrs.investment.peak_change", label: "Equity/debt investment" },
          { indicator: "extfin.lrs.deposit.peak_change", label: "Deposits" },
          { indicator: "extfin.lrs.property.peak_change", label: "Property" },
          { indicator: "extfin.lrs.others.peak_change", label: "Others" },
          { indicator: "extfin.lrs.medical.peak_change", label: "Medical treatment" },
          { indicator: "extfin.lrs.donations.peak_change", label: "Donations" }
        ],
        why: "A lower total hid opposite movements inside the table.",
        read: "Each row compares the same purpose in FY2023-24 and FY2025-26, with the absolute dollar change.",
        watch: "The chart establishes which categories moved. It cannot establish whether tax rules, exchange rates, visas or household demand caused the movement." },
      { indicator: "extfin.lrs.purpose.latest_vs_own_peak", chart: "tableBars", title: "Each purpose peaked in a different year", size: "feature", beat: "own-peak", unit: "% of its own peak",
        subtitle: "Latest annual amount divided by that purpose's own record · 100% means FY2025-26 is a new high",
        why: "The overall LRS peak is not every category's peak; this tests each purpose against the most relevant high-water mark in its own history.",
        read: "A bar at 100% means FY2025-26 is that purpose's record year. Shorter bars show how far the latest value sits below its own maximum.",
        watch: "A low percentage does not imply a policy effect or permanent decline, and tiny categories can have large percentage moves from small bases." },
      { chart: "multiLine", title: "Equity and debt investment pulled away from deposits and property", size: "feature", beat: "asset-shift", unit: "US$ billion",
        subtitle: "Annual LRS amount used for overseas equity or debt, bank deposits and property · FY2009-10 to FY2025-26",
        indicator: "extfin.lrs.investment.fy",
        series: [
          { indicator: "extfin.lrs.investment.fy", label: "Equity or debt investment", emphasis: true },
          { indicator: "extfin.lrs.deposit.fy", label: "Bank deposits" },
          { indicator: "extfin.lrs.property.fy", label: "Property purchases" }
        ],
        why: "The combined asset-building line hides a sharp rise in securities investment, a smaller property increase and a deposit series that has fallen from its peak.",
        read: "Compare both the latest levels and the different paths of the three purposes; equity or debt investment becomes the dominant line.",
        watch: "These are gross outward remittances by declared purpose, not overseas wealth, net investment, portfolio value or evidence that the money never returned." },
      { indicator: "extfin.lrs.travel_split.mar_apr_2026", chart: "tableBars", title: "Education made up about 40% of RBI's new Travel breakdown", size: "feature", beat: "travel-inside", unit: "percent of Travel",
        subtitle: "Share of Travel remittances assigned to RBI's five new subcategories · March and April 2026, the only months available",
        why: "The new subcategories show that the word Travel is broader than foreign holidays.",
        read: "The bars divide the two-month Travel total into other travel, education, business, pilgrimage and medical travel.",
        watch: "Two months are a snapshot, not an annual estimate. Other travel also includes some international credit-card settlements, not only holidays." },
      { chart: "multiLine", title: "LRS Travel grew much faster than Indian-national departures", size: "feature", beat: "outside-comparison", unit: "index (2016=100)", fromYear: 2016,
        subtitle: "Growth in LRS Travel remittances compared with departures by Indian nationals · both set to 100 in 2016 · through 2024",
        indicator: "extfin.lrs.travel_index_2016",
        series: [
          { indicator: "extfin.lrs.travel_index_2016", label: "LRS Travel remittances", emphasis: true },
          { indicator: "tourism.outbound_departures_index_2016", label: "Indian-national departures" }
        ],
        why: "Departure counts rose, but not at the pace of the recorded Travel remittance series.",
        read: "Both lines equal 100 in 2016, so their pace can be compared despite different units.",
        watch: "Do not divide one by the other as spending per trip. Departures are movements, not unique leisure travellers, while LRS Travel contains education and several payment types." },
      { indicator: "extfin.lrs.total.monthly", chart: "line", title: "Two 2023 spikes line up with the original and deferred TCS dates", size: "feature", beat: "monthly-timing", unit: "US$ billion", fromYear: 2022,
        subtitle: "Monthly total sent abroad under LRS by people resident in India · sum of RBI's ten main purposes · January 2022 to April 2026",
        why: "Annual totals hide the June and September 2023 timing spikes and the quieter months after them.",
        read: "The monthly line is the same ten-purpose total at higher frequency.",
        watch: "Timing around the October 2023 TCS change is not proof that TCS caused the later decline. Remitters could also respond to fees, travel calendars, exchange rates or other rules." }
    ]
  },
  {
    id: "q.econ.growth",
...

  {
    ...
    indicators: [
      ...
      "derived.IN.fx.decade_fall", "derived.IN.fx.peer_fall_vs_usd", "derived.IN.fx.crisis_scorecard", "macro.current_account_usd", "IN.bop.current_account_pct_gdp.annual",
    ...
    visualPlan: [
      ...
      { indicator: "IN.fx.inr_usd_long.annual", chart: "line", title: "One dollar in rupees, from fixed pegs to a managed float", size: "hero", window: "full", beat: "the-number", subtitle: "What one US dollar has cost in rupees since Independence, separating fixed pegs and devaluations from the later managed market rate.",
        why: "This is the headline number, but it must be read as regime history: fixed pegs first, one-off devaluations next, and a managed float after 1993.", read: "Rupees per US dollar from 1947 to the latest monthly data. A higher line means a weaker rupee; the flat early stretches are fixed pegs, not market calm.", watch: "Pre-1993 values are official par rates. Post-1993 values are market rates that the RBI still manages, so do not treat the full line as one continuous free-market verdict." },
      { indicator: "derived.IN.fx.decade_fall", chart: "tableBars", title: "The rupee's dollar fall came in bursts, not a steady slide", size: "feature", beat: "decade-fall", subtitle: "How much dollar value the rupee lost in each decade, showing that the largest falls came in specific crisis and adjustment periods.", unit: "% of value lost vs the dollar",
        why: "The rupee did not weaken at a constant pace; decade bars show where the real breaks happened.", read: "Each bar is the percentage of the rupee-dollar value lost in that decade. The 1960s, 1980s and 1990s dominate; the 2000s were close to flat.", watch: "Fixed-peg decades can look calm because policy held the rate, not because market pressure was absent." },
      { chart: "multiLine", title: "The rupee fell most against the dollar, not equally against every currency", size: "feature", beat: "rupee-vs-currencies", subtitle: "The rupee's value against the dollar, euro, pound and yen since 1999, all indexed to show that the bilateral story depends on the other currency too.", unit: "value of the rupee (1999 = 100)",
        ...
        why: "A currency is always a pair, and the rupee-dollar headline hides how differently the rupee moved against other major currencies.", read: "All lines start at 100 in 1999. By June 2026 the rupee value index was about 44.8 against the dollar, 45.0 against the euro, 55.4 against the pound and 63.5 against the yen.", watch: "These are bilateral exchange rates, not a trade-weighted measure of competitiveness." },
      { indicator: "derived.IN.fx.peer_fall_vs_usd", chart: "tableBars", title: "The rupee was mid-pack in a strong-dollar world", size: "feature", beat: "peer-comparison", subtitle: "How much major currencies lost against the US dollar from 2000 to 2025, placing the rupee beside peers instead of judging it in isolation.", unit: "% of value lost vs the dollar, 2000-2025",
        why: "The dollar was unusually strong over this period, so the right test is whether the rupee was an outlier, not whether it fell at all.", read: "The rupee lost 48.4% of its dollar value from 2000 to 2025. The Brazilian real, South African rand and Mexican peso lost more; several currencies did better.", watch: "This comparison is still against the dollar. It is not a ranking of overall national performance." },
      // --- ACT 2: A PEGGED INHERITANCE, AND TWO DEVALUATIONS (1947-1991) ---
      { indicator: "derived.IN.reserves.total_usd.monthly", chart: "line", title: "Reserves grew from a few weeks of imports to a $686 billion buffer", size: "feature", window: "full", beat: "reserves-arc", subtitle: "India's foreign-exchange reserves including gold, showing the 1991 near-empty cupboard and the much larger modern cushion.",
        why: "Reserves are the difference between depreciation under pressure and a full external payments crisis.", read: "RBI monthly data put reserves near $686 billion in May 2026. DBIE weekly data showed about $667 billion on 26 June 2026, a different date and frequency.", watch: "Reserve totals are a buffer, not an unlimited defence. Some support can also be committed through forwards." },
      { indicator: "macro.current_account_usd", chart: "line", title: "The current-account deficit is where rupee crises begin", size: "feature", window: "full", beat: "current-account", subtitle: "The gap between what India earns from the world and what it spends abroad, before capital flows cover or fail to cover it.",
        why: "A current-account deficit is the recurring place where trade, oil, services, remittances and capital flows meet the rupee.", read: "The current-account deficit reached about $88 billion in 2012-13. The latest full-year RBI reading is about $25.4 billion for 2025-26; CAD was about 0.6% of GDP in 2024-25.", watch: "A deficit is not automatically a crisis. It becomes dangerous when it is large or financed by flighty capital." },
      { indicator: "derived.IN.fx.crisis_scorecard", chart: "tableBars", title: "Each rupee crisis had a different mix of pressures", size: "feature", beat: "crisis-scorecard", subtitle: "A curated stress scorecard across major rupee episodes, combining devaluation/depreciation, external deficit, reserves, hot money or dollar pressure, oil and policy stress.", unit: "stress score, 0-10",
        why: "This is the adversarial check: if the article says many things move the rupee, crisis episodes should show different mixes of those things.", read: "1991 ranks highest because reserves nearly ran out and the peg broke; 2013 ranks high because a record current-account deficit met a global dollar/rate shock; 2025-26 is lower because reserves are large and the current account is modest, despite FPI outflows and a large forward book.", watch: "The score is an editorial severity marker, not a statistical model. Early episodes have patchier monthly data than post-1993 market episodes." },
      { indicator: "IN.rates.policy_rate.monthly", chart: "line", title: "Interest rates rose in crises, but they do not set the rupee alone", size: "small", window: "full", beat: "policy-rate", subtitle: "The RBI's main policy rate across regimes, showing how monetary policy interacts with inflation, growth and currency defence.",
        why: "Rates matter for capital flows, but raising rates to defend the rupee has domestic costs.", read: "The latest BIS policy-rate reading is 5.25% for May 2026. Past currency and inflation scares show up as higher-rate episodes.", watch: "The policy rate is one lever among many. It does not mechanically determine the exchange rate." },
      // --- ACT 3: LEARNING TO FLOAT, AND WHAT THE RBI ACTUALLY DOES ---
      { chart: "multiLine", title: "A narrow monthly range shows the rupee is managed, not freely floating", size: "small", beat: "managed-float", subtitle: "The strongest and weakest rupee-dollar quote within each month, exposing how tightly the exchange rate is often smoothed.", unit: "INR per USD",
        ...
        why: "The monthly high-low band is a visible fingerprint of a managed float.", read: "In June 2026 the reported range ran from about Rs 94.28 at the stronger end to about Rs 95.78 at the weaker end.", watch: "A narrow range can reflect calm markets, active smoothing or both. Price data alone cannot fully separate them." },
      { indicator: "IN.fx.rbi_net_intervention_usd.monthly", chart: "line", title: "RBI spot intervention: buying dollars in calm, selling in stress", size: "feature", window: "full", beat: "intervention", subtitle: "The RBI's net spot dollar purchases and sales, the most visible part of how it smooths the rupee.",
        why: "Intervention data shows currency management in actual dollars bought and sold.", read: "Positive values mean the RBI bought dollars; negative values mean it sold dollars. It sold about $9.76 billion in March 2026 and $8.94 billion in April 2026.", watch: "This is spot intervention only. The forward book is a separate and sometimes larger commitment." },
      { chart: "multiLine", title: "Hot portfolio money is the tide the RBI leans against", size: "feature", beat: "fpi-vs-intervention", subtitle: "Foreign portfolio flows beside RBI spot intervention, showing why fast-moving capital matters for rupee volatility.", unit: "US$ millions",
        ...
        why: "RBI research points to portfolio flows as a central source of rupee volatility; this chart shows the mechanism.", read: "Portfolio outflows were about $13.34 billion in March 2026 and $7.26 billion in April 2026, while RBI spot sales remained large in both months.", watch: "This is correlation, not a one-for-one reaction function. Stress months have several moving parts." },
      { indicator: "IN.fx.rbi_forward_book_usd.monthly", chart: "line", title: "The RBI's forward book is committed defence, not free reserves", size: "small", window: "full", beat: "forward-book", subtitle: "The RBI net forward dollar position, where selling dollars for future delivery can support the rupee without immediately reducing spot reserves.",
        why: "Forwards reveal currency defence that does not immediately show up as a fall in visible reserves.", read: "The RBI's net forward book reached about -$103 billion in March 2026 and was about -$95 billion in April.", watch: "A negative forward book is support already promised for the future. It is not the same as free reserve firepower." },
      { chart: "multiLine", title: "FDI is slower; FPI is the money that whipsaws the rupee", size: "feature", beat: "fdi-vs-fpi", subtitle: "Foreign direct investment beside portfolio flows, separating stickier long-term money from fast-moving market money.", unit: "US$ millions",
        ...
        why: "Not all foreign capital behaves alike, and the rupee reacts most to the money that can leave fastest.", read: "In April 2026, net FDI was about $6.58 billion while net FPI was about -$7.26 billion.", watch: "FDI is lumpy and often revised. The robust point is the volatility contrast, not any one month." },
      { chart: "multiLine", title: "The rupee often moves with the global dollar cycle", size: "small", beat: "global-drivers", subtitle: "The rupee-dollar rate beside a broad emerging-market dollar index, showing the global driver behind many rupee moves.", unit: "index", fromYear: 2006,
        ...
        why: "Many rupee falls happen when the dollar strengthens broadly, not only when Indian news worsens.", read: "When the global dollar index rises against emerging-market currencies, the rupee-dollar line usually weakens too.", watch: "The two series are different indices. Read the mirror-image shape, not the exact levels." },
      { chart: "line", title: "Rupee volatility reveals how tightly the RBI held it", size: "feature", beat: "regime-volatility", unit: "INR per USD", fromYear: 2000,
        subtitle: "The rupee-dollar rate split into de-facto management regimes, using volatility as a clue to how freely the rupee was allowed to move.",
        ...
        why: "The RBI does not announce a target band, so realised volatility is one way to infer how tightly the rupee was managed.", read: "The labels mark de-facto regimes from Sengupta and Shah, with very low volatility in some managed periods and higher volatility during freer or stressed periods.", watch: "Low volatility can reflect both intervention and calm markets. The regime labels are an interpretation, not an official RBI classification." },
      // --- ACT 4: WHAT THE NUMBER NEVER TOLD YOU (THE REVEAL) ---
      { chart: "multiLine", title: "Against the dollar it collapsed; in real trade-weighted terms, much less", size: "hero", beat: "nominal-vs-real", subtitle: "The rupee measured three ways since 1994: against the dollar, against trading partners, and after adjusting for inflation.", unit: "index (Jan 1994 = 100)",
        ...
        why: "This is the core reveal: the dollar chart is not the same as the inflation-adjusted trade-weighted rupee.", read: "All three start at 100 in January 1994. By May 2026 the dollar-value index was about 33, broad NEER about 40 and broad REER about 95.", watch: "REER stability does not mean no one feels pain. It means competitiveness looks much flatter after inflation and trade weights are included." },
      { chart: "multiLine", title: "The long real rupee: overvaluation, 1991 correction, managed range", size: "feature", beat: "long-reer", subtitle: "RBI's long NEER and REER history, chain-linked across the discontinued 36-country basket and the newer 40-country basket.", unit: "index (1985 = 100)",
        ...
        why: "The half-century view shows correction and managed fluctuation, not a simple collapse.", read: "The chain-linked RBI long REER was about 101 in May 2026 on its 1985-base scale, after an overvalued 1970s-80s and the 1991 correction.", watch: "The post-2020 continuation is chain-linked because RBI discontinued the 36-country basket. Compare shape across the join, not exact levels." },
      { chart: "multiLine", title: "Higher Indian inflation is the long-run pressure on the rupee", size: "feature", beat: "inflation-gap", subtitle: "The cumulative cost of living in India and the US since 1991, showing why a fixed dollar rate would have become hard to sustain.", unit: "index (1991 = 100)",
        ...
        why: "A country with persistently higher inflation usually needs a weaker nominal currency over time to protect competitiveness.", read: "Since 1991, India’s cumulative price index has risen much more than the US index. That inflation gap is the long-run reason the rupee trends weaker.", watch: "Inflation explains the long-run direction, not every monthly move." },
      { chart: "multiLine", title: "Inflation explains much of the fall, but not the overshoot", size: "feature", beat: "ppp", subtitle: "The actual rupee-dollar rate beside a simple PPP-implied rate based only on the India-US inflation gap.", unit: "INR per USD", fromYear: 1994,
        ...
        indicator: "IN.fx.inr_usd.monthly",
        why: "PPP gives a useful baseline, and the gap from that baseline shows what inflation alone cannot explain.", read: "On the common March 2026 date, PPP implied about Rs 79.06 per dollar while the actual rate was about Rs 92.82, roughly 17% weaker than the inflation-only line.", watch: "Bilateral PPP is a rough model, not a fair-value estimate. The overshoot can reflect capital flows, risk and broad dollar strength." },
      { chart: "multiLine", title: "The inflation gap matters over decades, not every month", size: "small", beat: "inflation-diff", subtitle: "Year-on-year inflation in India and the US, useful for seeing direction but too noisy for month-by-month exchange-rate claims.", unit: "% year-on-year", fromYear: 1954,
        ...
        why: "Annual inflation rates explain pressure over time, but the rupee does not mechanically follow each monthly inflation print.", read: "India’s inflation has usually run above US inflation over the long period, though the gap changes and sometimes narrows.", watch: "Use this for the cumulative long-run mechanism, not for short-term trading calls." },
      { chart: "multiLine", title: "The same exports look different in rupees and dollars", size: "feature", beat: "dual-currency-exports", subtitle: "India’s merchandise exports indexed in rupees and dollars, showing how depreciation changes the measurement without creating extra real exports.", unit: "index (1970 = 100, log scale)", logScale: true,
        ...
        why: "The same trade flow can look explosive in rupees and much calmer in dollars because the exchange rate changes the unit of measurement.", read: "Since 1970, the exports index grew far more in rupees than in dollars; the gap is largely the depreciation of the rupee.", watch: "This is a log scale, so equal vertical steps mean equal percentage changes. RBI rupee trade data have a missing 1984 row, which is bridged in the derived index." },
      // --- ACT 5: DID YOU ACTUALLY LOSE MONEY? ---
      { chart: "multiLine", title: "A banked rupee did not behave like cash under a mattress", size: "hero", beat: "counterfactual", subtitle: "One rupee rolled through a representative bank deposit since 1970, compared with the rising cost of living.", unit: "rupees (1970 = 1)",
        ...
        why: "Households do not usually store long-term wealth as currency notes, so the saver’s question needs a return and inflation frame.", read: "One rupee placed in a representative 1-3 year deposit in 1970 grew to about Rs 62.6 by 2024, while the cost-of-living index rose to about 38.1.", watch: "This ignores tax, product choice and household-specific inflation. It is a counterfactual, not a promise." },
      { indicator: "derived.IN.rates.real_deposit_rate", chart: "line", title: "Bank deposits did not always beat inflation", size: "small", window: "full", beat: "real-deposit-rate", subtitle: "The representative bank deposit rate after subtracting inflation, showing why some decades were punishing for savers.",
        why: "The savings counterfactual needs this caveat: over the full period deposits won, but not in every year.", read: "Real deposit rates were often negative in the 1970s and early 1980s, then became more reliably positive after the reform period. The latest annual reading is about 4.66% in 2025.", watch: "This uses one representative deposit-rate series and one inflation series. Treat levels as approximate; the sign and era shift are the main signal." },
      // --- ACT 6: WHAT IT COSTS YOU ---
      { chart: "multiLine", title: "Oil in rupees: global crude plus exchange-rate pain", size: "feature", beat: "oil-two-currencies", subtitle: "Brent crude indexed in dollars and rupees since 2000, showing how depreciation stacks on top of the world oil price.", unit: "index (Jan 2000 = 100)",
        ...
        why: "Oil is the cleanest example of why a stable REER does not protect households from dollar-priced imports.", read: "Since January 2000, Brent crude rose to about 414.7 on a dollar index and 908.8 on a rupee index by May 2026.", watch: "Retail fuel prices also include taxes and margins. This chart is the import-cost channel, not the pump price." },
      { indicator: "IN.trade.imports_oil_usd.annual", chart: "line", title: "India's oil bill is the biggest recurring dollar drain", size: "small", window: "full", beat: "oil-bill", subtitle: "India's annual petroleum import bill in dollars, the recurring expense that makes oil central to rupee vulnerability.",
        why: "Oil is India’s largest recurring import bill and a major channel from rupee weakness to domestic prices.", read: "RBI trade data put petroleum imports at about $174 billion in 2025, moving with world oil prices, import volumes and the exchange rate's domestic cost.", watch: "The bill is in dollars. The rupee affects the domestic cost, while global price and volume drive the dollar total." },
      { indicator: "IN.extfin.usd_credit_nonbank.quarterly", chart: "line", title: "Dollar debt gets heavier when the rupee weakens", size: "small", window: "full", beat: "dollar-debt", subtitle: "Dollar-denominated credit to Indian non-bank borrowers, where the rupee cost rises even if the dollar debt itself does not.",
        why: "Depreciation hurts borrowers who earn in rupees but owe in dollars.", read: "BIS data show dollar credit to Indian non-bank borrowers rising from about $14 billion in 2005 to a peak near $142 billion in 2020, then easing to about $118 billion by end-2025.", watch: "This is only dollar-denominated non-bank credit. It is not all external debt and not government rupee debt." },
      { indicator: "IN.extfin.remittances_received_usd.annual", chart: "line", title: "Remittances are the other side of depreciation", size: "small", window: "full", beat: "remittances", subtitle: "Money sent home by Indians abroad, where each dollar converts into more rupees when the exchange rate weakens.",
        why: "Depreciation has losers and beneficiaries; remittance recipients are one obvious beneficiary group.", read: "World Bank data put personal remittances received by India at about $137.7 billion in 2024.", watch: "A weaker rupee raises the rupee conversion value of remittances. It does not create the dollar earnings abroad." },
      { chart: "multiLine", title: "The goods trade gap keeps India hunting for dollars", size: "small", beat: "trade-gap", subtitle: "Merchandise exports and imports in dollars, showing the persistent goods deficit that services, remittances and capital flows must finance.", unit: "US$ millions",
